...
def plot_pixel_values(x, y):
    ...
    try:
        ...
        for idx, file_path in enumerate(image_files, start=1):
            ...
            # Append index (1 to 114) as image dates
            image_dates.append(idx)
        ...
        # Plot normalized pixel values against image_dates
        plt.figure()
        plt.plot(image_dates, normalized_values, marker='o', linestyle='-', color='b')

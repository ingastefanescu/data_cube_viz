# -*- coding: utf-8 -*-
"""
Created on Thu Jun 13 19:32:29 2024
...
load_button = tk.Button(root, text="Load Spectral Index", command=load_spectral_index, bg="#4CAF50", fg="white", font=("Arial", 12, "bold"))

select_image_button = tk.Button(root, text="Select Image", command=select_and_display_image, bg="#FF5722", fg="white", font=("Arial", 12, "bold"))

open_tsne_window_button = tk.Button(root, text="Open t-SNE Options", command=open_tsne_window, bg="#2196F3", fg="white", font=("Arial", 12, "bold"))

open_pca_window_button = tk.Button(root, text="Open PCA Options", command=open_pca_window, bg="#FF9800", fg="white", font=("Arial", 12, "bold"))

# -*- coding: utf-8 -*-
"""
Created on Tue Feb  6 18:17:04 2024
...
# Calculate regression metrics
mse = mean_squared_error(train_vector.values, train_predictions)
mae = mean_absolute_error(train_vector.values, train_predictions)
r2 = r2_score(train_vector.values, train_predictions)
...
plt.plot(train_vector.index, train_vector.values, label='Actual (Train)', color='blue', marker='o')
plt.plot(train_vector.index, train_predictions_array, label='Predicted (Train)', color='green', marker='x')
plt.xlabel('Time')  # Change this to the appropriate label for your x-axis
plt.ylabel('Value')  # Change this to the appropriate label for your y-axis
plt.legend()

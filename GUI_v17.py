...
def open_coordinates_window():
    ...
    open_browser_button = tk.Button(coordinates_window, text="Open Browser", command=open_html_in_browser, bg="#2196F3", fg="white", font=("Arial", 12, "bold"))
    open_browser_button.pack(pady=10)
    
    update_button = tk.Button(coordinates_window, text="Update", command=lambda: plot_pixel_values_coord(x_entry.get(), y_entry.get(), coordinates_window),  bg="#9C27B0", fg="white", font=("Arial", 12, "bold"))
    ...
    clear_button = tk.Button(coordinates_window, text="Clear all plots", command=clear_html_file, bg="red", fg="white", font=("Arial", 12, "bold"))
...
#enter_coord = tk.Button(button_frame, text="Enter Coordinates", command=open_coordinates_window, bg="#388E3C", fg="white", font=("Arial", 12, "bold"))
